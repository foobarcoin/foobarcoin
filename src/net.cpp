...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "FBc " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"a.foobarcoin.org", "fbc.foobarcoin.org"},
    {"b.foobarcoin.org", "fbc.foobarcoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"a.foobarcoin.org", "testnet.fbc.foobarcoin.org"},
    {"b.foobarcoin.org", "testnet.fbc.foobarcoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. FBc is probably already running."), addrBind.ToString().c_str());
        else
